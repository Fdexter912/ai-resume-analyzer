...
const Upload = () => {
    ...
    const handleAnalyze = async ({companyName, jobTitle, jobDescription, file}: { companyName: string, jobTitle: string, jobDescription: string, file: File }) => {
        ...
        if(!imageFile || imageFile.error || !imageFile.file) return setStatusText(`Failed to convert PDF to image: ${imageFile?.error ?? 'Unknown error'}`);
        ...
        await kv.set(`resume:${uuid}`, JSON.stringify(data));
        setStatusText('Analysis completed, fetching results...');
        console.log(data);
